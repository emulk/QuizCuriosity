...
public class Logo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		imageview.setImageDrawable(getResources().getDrawable(
				(Utility.GetNewCar())));
		zero.setText(Utility.RightAnswer());
		uno.setText(randomString = Utility.LogoOracle());
		due.setText(randomString = Utility.LogoOracle());
		tre.setText(randomString = Utility.LogoOracle());
		wrong(uno, due, tre);
		...
		zero.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				imageview.setImageDrawable(getResources().getDrawable(
						Utility.GetNewCar()));
				uno.setText(Utility.RightAnswer());
				zero.setText(randomString = Utility.LogoOracle());
				...
				uno.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						imageview.setImageDrawable(getResources().getDrawable(
								Utility.GetNewCar()));
						tre.setText(Utility.RightAnswer());
						zero.setText(randomString = Utility.LogoOracle());
						uno.setText(randomString = Utility.LogoOracle());
						due.setText(randomString = Utility.LogoOracle());
									...
									public void onClick(View v) {
										...
										imageview
												.setImageDrawable(getResources()
														.getDrawable(
																Utility.GetNewCar()));
										due.setText(Utility.RightAnswer());
										zero.setText(randomString = Utility
												.LogoOracle());
										uno.setText(randomString = Utility
												.LogoOracle());
										
										tre.setText(randomString = Utility
												.LogoOracle());
										wrong(tre, uno, zero);
										due.setOnClickListener(new View.OnClickListener() {
											...
											public void onClick(View v) {
												...
												due.setText(randomString = Utility
														.LogoOracle());
												tre.setText(randomString = Utility
														.LogoOracle());
												wrong(tre, due, zero);
	...
	/**
	 * UpdatePerdite e' come IncPerdite ma invece di inserire una nuova righa nel database va a leggere l'ultima righa e la aggiorna
	 * in questo modo ho meno spreco di spazzio nel database
	 */
	private void UpdatePerdite() {
		...
		if (cursorlast.moveToLast()) {
			...
			tempo = cursorlast.getInt(Database.COL_TEMPO);
			obiettivi = cursorlast.getInt(Database.COL_OBIETTIVI);
			Log.d(TAG,"Dentro l'if di UpdatePerdite con la righa: "+rowID);
