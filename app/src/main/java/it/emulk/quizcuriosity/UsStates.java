...
public class UsStates extends Activity {
	...
	private static final String TAG = "UsStates";
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.usstates);
		...
		imageview = (ImageView) findViewById(R.id.UsStates);
		...
		imageview.setImageDrawable(getResources().getDrawable(
				(UtilityUsStatesFlag.GetNewFlag())));

		uno.setText(randomString = UtilityUsStatesFlag.LogoOracle());
		due.setText(randomString = UtilityUsStatesFlag.LogoOracle());
		tre.setText(randomString = UtilityUsStatesFlag.LogoOracle());
		wrong(uno, due, tre);
		zero.setText(UtilityUsStatesFlag.RightAnswer());
		zero.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				imageview.setImageDrawable(getResources().getDrawable(
						UtilityUsStatesFlag.GetNewFlag()));
				zero.setText(randomString = UtilityUsStatesFlag.LogoOracle());
				uno.setText(UtilityUsStatesFlag.RightAnswer());
				due.setText(randomString = UtilityUsStatesFlag.LogoOracle());
				// wrong(uno);
				tre.setText(randomString = UtilityUsStatesFlag.LogoOracle());
				wrong(zero, due, tre);
				...
				uno.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						uno.setText(randomString = UtilityUsStatesFlag.LogoOracle());
						due.setText(randomString = UtilityUsStatesFlag.LogoOracle());
						tre.setText(UtilityUsStatesFlag.RightAnswer());
						wrong(zero, due, uno);
						tre.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								imageview.setImageDrawable(getResources()
										.getDrawable(UtilityUsStatesFlag.GetNewFlag()));
								zero.setText(UtilityUsStatesFlag.RightAnswer());
								uno.setText(randomString = UtilityUsStatesFlag.LogoOracle());
								due.setText(randomString = UtilityUsStatesFlag.LogoOracle());
								tre.setText(randomString = UtilityUsStatesFlag.LogoOracle());
									...
									public void onClick(View v) {
										...
										imageview
												.setImageDrawable(getResources()
														.getDrawable(
																UtilityUsStatesFlag.GetNewFlag()));
										due.setText(UtilityUsStatesFlag.RightAnswer());
										zero.setText(randomString = UtilityUsStatesFlag
												.LogoOracle());
										uno.setText(randomString = UtilityUsStatesFlag
												.LogoOracle());

										tre.setText(randomString = UtilityUsStatesFlag
												.LogoOracle());
										wrong(tre, uno, zero);
											...
											public void onClick(View v) {
												...
												imageview
														.setImageDrawable(getResources()
																.getDrawable(
																		UtilityUsStatesFlag.GetNewFlag()));
												uno.setText(UtilityUsStatesFlag
														.RightAnswer());
												zero.setText(randomString = UtilityUsStatesFlag
														.LogoOracle());

												due.setText(randomString = UtilityUsStatesFlag
														.LogoOracle());
												tre.setText(randomString = UtilityUsStatesFlag
														.LogoOracle());
												wrong(tre, due, zero);
													...
													public void onClick(View v) {
														...
														imageview
																.setImageDrawable(getResources()
																		.getDrawable(
																				UtilityUsStatesFlag.GetNewFlag()));
														zero.setText(UtilityUsStatesFlag
																.RightAnswer());
														uno.setText(randomString = UtilityUsStatesFlag
																.LogoOracle());
														due.setText(randomString = UtilityUsStatesFlag
															...
															public void onClick(
																...
																imageview
																		.setImageDrawable(getResources()
																				.getDrawable(
																						UtilityUsStatesFlag.GetNewFlag()));
																tre.setText(UtilityUsStatesFlag
																		.RightAnswer());
																zero.setText(randomString = UtilityUsStatesFlag
																		.LogoOracle());
																uno.setText(randomString = UtilityUsStatesFlag
																							...
																							public void onClick(
																								...
																								imageview
																										.setImageDrawable(getResources()
																												.getDrawable(
																														UtilityUsStatesFlag.GetNewFlag()));
																								due.setText(UtilityUsStatesFlag
																										.RightAnswer());
																								zero.setText(randomString = UtilityUsStatesFlag
																										.LogoOracle());
																								uno.setText(randomString = UtilityUsStatesFlag
