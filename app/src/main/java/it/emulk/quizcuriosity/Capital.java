...
public class Capital extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MobileAds.initialize(getApplicationContext(), "ca-app-pub-4209540176643828~2496492990");
		...
		RightFlag=(TextView) findViewById(R.id.rightflag);
		...
		imageview.setImageDrawable(getResources().getDrawable(
				(UtilityCapital.GetNewFlag())));
		RightFlag.setText(UtilityCapital.RightAnswer());
		zero.setText(UtilityCapital.RightCapital());
		uno.setText(randomString = UtilityCapital.LogoOracle());
		due.setText(randomString = UtilityCapital.LogoOracle());
		tre.setText(randomString = UtilityCapital.LogoOracle());
		wrong(uno, due, tre);
		...
		zero.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				imageview.setImageDrawable(getResources().getDrawable(
						UtilityCapital.GetNewFlag()));
				RightFlag.setText(UtilityCapital.RightAnswer());
				uno.setText(UtilityCapital.RightCapital());
				zero.setText(randomString = UtilityCapital.LogoOracle());
				...
				uno.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						imageview.setImageDrawable(getResources().getDrawable(
								UtilityCapital.GetNewFlag()));
						RightFlag.setText(UtilityCapital.RightAnswer());
						tre.setText(UtilityCapital.RightCapital());
						zero.setText(randomString = UtilityCapital.LogoOracle());
						uno.setText(randomString = UtilityCapital.LogoOracle());
						due.setText(randomString = UtilityCapital.LogoOracle());
						...
						tre.setOnClickListener(new View.OnClickListener() {
							...
							public void onClick(View v) {
								...
								imageview.setImageDrawable(getResources()
										.getDrawable(UtilityCapital.GetNewFlag()));
								RightFlag.setText(UtilityCapital.RightAnswer());
								zero.setText(UtilityCapital.RightCapital());
								uno.setText(randomString = UtilityCapital.LogoOracle());
								due.setText(randomString = UtilityCapital.LogoOracle());
										...
										imageview
												.setImageDrawable(getResources()
														.getDrawable(
																UtilityCapital.GetNewFlag()));
										RightFlag.setText(UtilityCapital.RightAnswer());
										due.setText(UtilityCapital.RightCapital());
										zero.setText(randomString = UtilityCapital
												.LogoOracle());
										uno.setText(randomString = UtilityCapital
												.LogoOracle());
										
										tre.setText(randomString = UtilityCapital
												.LogoOracle());
										wrong(tre, uno, zero);
												...
												imageview
														.setImageDrawable(getResources()
																.getDrawable(
																		UtilityCapital.GetNewFlag()));
												RightFlag.setText(UtilityCapital.RightAnswer());
												uno.setText(UtilityCapital
														.RightCapital());
												zero.setText(randomString = UtilityCapital
														.LogoOracle());
												
												due.setText(randomString = UtilityCapital
														.LogoOracle());
												tre.setText(randomString = UtilityCapital
														.LogoOracle());
												wrong(tre, due, zero);
																																							...
																																							public void onClick(
																																								...
																																								due.setOnClickListener(new View.OnClickListener() {
																																									...
																																									public void onClick(
																																										...
																																										RightFlag.setVisibility(View.INVISIBLE);
																																										due.setText("Quit");
																																										due.setOnClickListener(new View.OnClickListener() {
